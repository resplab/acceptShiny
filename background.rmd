...
For a detailed discription of the model, please refer to the [publication](http://resp.core.ubc.ca/publications/accept). ACCEPT is also available as an Excel spreadsheet, R package, and API. Please refer to project [homepage](http://resp.core.ubc.ca/research/Specific_Projects/accept) for more information. 
